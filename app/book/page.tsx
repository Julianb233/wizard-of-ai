...
import { ArrowLeft, BookOpen, Mail, Sparkles, CheckCircle } from "lucide-react"
...
const sparkles = [
  ...
  { left: "25%", top: "85%", delay: 1.1, size: "lg" },
]
...
const bookBenefits = [
  "Master AI tools that save 10+ hours per week",
  "Automate repetitive tasks across your business",
  "Build custom AI agents for your specific needs",
  "Learn prompt engineering secrets from the pros",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                <BookOpen className="w-12 h-12 text-[#D4A84B]" />
              </motion.div>
              ...
              >
                <span className="block text-[#FDF8E8]">Humans + AI</span>
                <motion.span
                ...
                >
                  How to Leverage AI Tools to Make You and Your Team Super Human
                </motion.span>
              </motion.h1>
              ...
              >
                A practical playbook for leaders, teams, and creators to turn AI into a real-world advantage—without losing the human edge.
              </motion.p>
              ...
              >
                {bookBenefits.map((benefit, index) => (
                  ...
                  >
                    <CheckCircle className="w-5 h-5 text-[#D4A84B] mt-0.5 flex-shrink-0" />
                    <span className="text-[#FDF8E8]/80">{benefit}</span>
                  </motion.div>
                ))}
              </motion.div>
              ...
              >
                ...
                <p className="text-[#FDF8E8]/70 mb-6">
                  Join the waitlist and be the first to know when The Book is available. Plus, get exclusive
                  pre-launch bonuses and early-bird pricing.
                </p>
          ...
          >
            <p className="text-[#FDF8E8]/60 mb-6">
              Can't wait for the book? Get personalized AI guidance now with a free consultation.
            </p>
