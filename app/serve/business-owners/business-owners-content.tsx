...
import { TrendingUp, Clock, DollarSign, Users, Target, Zap, CheckCircle, ArrowRight } from "lucide-react"
...
const challenges = [
  {
    ...
    description: "Spending hours on repetitive work instead of growing your business",
  },
  {
    icon: DollarSign,
    title: "Rising Operational Costs",
    description: "Labor costs increasing while profit margins shrink",
  },
  {
    icon: Users,
    title: "Hiring Challenges",
    description: "Difficulty finding and retaining qualified staff for routine tasks",
  },
  {
    icon: Target,
    title: "Scaling Bottlenecks",
    description: "Growth limited by capacity to handle increased workload",
  },
]
...
const solutions = [
  {
    ...
    description: "Eliminate repetitive tasks with intelligent automation that runs 24/7, freeing your team to focus on high-value work.",
    impact: "Save 15-20 hours per week",
  },
  {
    title: "Smart Customer Service",
    description: "AI-powered chatbots and email responses that handle customer inquiries instantly, improving satisfaction.",
    impact: "Reduce response time by 90%",
  },
  {
    title: "Data-Driven Decisions",
    description: "Turn your business data into actionable insights with AI analytics that identify opportunities and risks.",
    impact: "Increase profitability by 25%",
  },
  {
    title: "Process Optimization",
    description: "Streamline operations from inventory management to scheduling with AI that learns and adapts to your business.",
    impact: "Cut operational costs by 30%",
  },
]
...
export default function BusinessOwnersContent() {
  return (
      ...
      <div className="pt-40 md:pt-48 pb-20 px-6 md:px-12 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <Zap className="w-5 h-5 text-[#D4A84B]" />
              <span className="text-[#D4A84B] font-bold text-sm uppercase tracking-wider">For Business Owners</span>
            </motion.div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight mb-6">
              <span className="text-[#FDF8E8]">Scale Your Business With</span>{" "}
              <span className="text-[#D4A84B]">AI Automation</span>
            </h1>
            <p className="text-[#F0D98C]/80 text-lg md:text-xl max-w-3xl mx-auto mb-8">
              Stop drowning in daily operations. Implement proven AI automation for small business that cuts costs by 30%, saves 20+ hours per week, and enables you to scale without hiring.
            </p>
            <motion.div
          ...
          >
            <h2 className="text-3xl md:text-4xl font-black text-[#FDF8E8] text-center mb-12">
              Common Challenges <span className="text-[#D4A84B]">We Solve</span>
            </h2>
          ...
          >
            <h2 className="text-3xl md:text-4xl font-black text-[#FDF8E8] text-center mb-12">
              How <span className="text-[#D4A84B]">AI Solves This</span>
            </h2>
          ...
          >
            <div className="bg-[#0D6B4F]/30 rounded-2xl p-8 md:p-12 border border-[#D4A84B]/20">
              <h2 className="text-3xl md:text-4xl font-black text-[#FDF8E8] mb-8 text-center">
                AI Services Built for <span className="text-[#D4A84B]">Your Business</span>
              </h2>
          ...
          >
            <div className="bg-gradient-to-r from-[#0D6B4F]/50 to-[#0D6B4F]/30 rounded-2xl p-12 border-2 border-[#D4A84B]/30">
              ...
              <p className="text-[#F0D98C]/80 text-lg mb-8 max-w-2xl mx-auto">
                Book a free 30-minute strategy session to discover how AI automation can save you 20+ hours per week and increase profits by 25% or more.
              </p>
              <motion.div
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
