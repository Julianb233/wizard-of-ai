...
import { Brain, Shield, TrendingUp, Users, Target, Zap, CheckCircle, ArrowRight } from "lucide-react"
...
const challenges = [
  {
    ...
    description: "Competitors adopting AI faster, threatening your market position",
  },
  {
    icon: Target,
    title: "Strategic Uncertainty",
    description: "Unclear on where and how to implement AI for maximum ROI",
  },
  {
    icon: Shield,
    title: "Risk Management",
    description: "Concerns about AI security, compliance, and ethical implementation",
  },
  {
    icon: Users,
    title: "Change Management",
    description: "Resistance from teams and uncertainty about workforce transformation",
  },
]
...
const solutions = [
  {
    ...
    description: "Comprehensive AI strategy aligned with your business objectives. We identify high-impact opportunities and create a phased implementation plan.",
    impact: "Clear path to AI adoption",
  },
  {
    title: "Enterprise AI Integration",
    description: "Seamlessly integrate AI into existing systems and workflows. From CRM to ERP, we ensure AI enhances rather than disrupts operations.",
    impact: "30% operational efficiency gain",
  },
  {
    title: "Executive Dashboards",
    description: "Real-time AI-powered analytics and insights. Make data-driven decisions with predictive analytics and automated reporting.",
    impact: "Faster, smarter decisions",
  },
  {
    title: "Team Training & Change Management",
    description: "Prepare your organization for AI transformation. We provide executive briefings, team training, and change management support.",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              ...
              <span className="text-[#D4A84B] font-bold text-sm uppercase tracking-wider">For CEOs & Executives</span>
            </motion.div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight mb-6">
              <span className="text-[#FDF8E8]">Strategic AI Implementation</span>{" "}
              <span className="text-[#D4A84B]">For Enterprise Leaders</span>
            </h1>
            <p className="text-[#F0D98C]/80 text-lg md:text-xl max-w-3xl mx-auto mb-8">
              Lead your organization into the AI era with confidence. Get executive AI strategy that drives innovation, reduces costs by 30%, and delivers measurable competitive advantage.
            </p>
            <motion.div
          ...
          >
            <h2 className="text-3xl md:text-4xl font-black text-[#FDF8E8] text-center mb-12">
              Executive Challenges <span className="text-[#D4A84B]">We Address</span>
            </h2>
          ...
          >
            <h2 className="text-3xl md:text-4xl font-black text-[#FDF8E8] text-center mb-12">
              Enterprise <span className="text-[#D4A84B]">AI Solutions</span>
            </h2>
          ...
          >
            <div className="bg-[#0D6B4F]/30 rounded-2xl p-8 md:p-12 border border-[#D4A84B]/20">
              <h2 className="text-3xl md:text-4xl font-black text-[#FDF8E8] mb-8 text-center">
                Executive <span className="text-[#D4A84B]">AI Services</span>
              </h2>
          ...
          >
            <div className="bg-gradient-to-r from-[#0D6B4F]/50 to-[#0D6B4F]/30 rounded-2xl p-12 border-2 border-[#D4A84B]/30">
              ...
              <p className="text-[#F0D98C]/80 text-lg mb-8 max-w-2xl mx-auto">
                Schedule a private executive briefing to explore how AI can transform your organization and deliver measurable competitive advantage.
              </p>
              <motion.div
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
