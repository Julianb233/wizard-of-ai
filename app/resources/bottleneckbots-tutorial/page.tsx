...
import { ArrowLeft, Video, Mail, Sparkles, Bot, Play } from "lucide-react"
...
export default function BottleneckBotsTutorialPage() {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <motion.div
                ...
                className="inline-flex p-4 bg-[#D4A84B]/20 rounded-2xl mb-6 relative"
              >
                ...
                >
                  <Bot className="w-6 h-6 text-[#E8C55A]" />
                </motion.div>
              </motion.div>
              ...
              >
                <span className="block text-[#FDF8E8]">BottleneckBots</span>
                <motion.span
              ...
              >
                Learn how to configure and deploy your first AI agent with BottleneckBots. Step-by-step video
                walkthrough covering installation, configuration, and your first automation workflow.
              </motion.p>
              ...
              >
                ...
                <div className="absolute inset-0 opacity-20">
                  {[...Array(6)].map((_, i) => (
                    <motion.div
                      key={i}
                      className="absolute w-px h-full bg-[#D4A84B]"
                      style={{ left: `${20 + i * 15}%` }}
                      animate={{
                        opacity: [0.2, 0.6, 0.2],
                      }}
                ...
                <div className="absolute bottom-4 left-4 right-4 text-center">
                  <p className="text-[#FDF8E8] font-bold text-lg">Tutorial Video Coming Soon</p>
                </div>
              </motion.div>
              ...
              >
                {[
                  ...
                  { title: "Visual Guide", desc: "Follow along easily" },
                  { title: "Real Examples", desc: "Practical use cases" },
                ].map((feature, i) => (
                  <div
                    key={i}
                    className="bg-[#0A4D3C]/40 rounded-xl p-4 border border-[#D4A84B]/20 text-center"
                  >
                    <p className="text-[#D4A84B] font-bold mb-1">{feature.title}</p>
                    <p className="text-[#FDF8E8]/60 text-sm">{feature.desc}</p>
                  </div>
                ))}
              </motion.div>
              ...
              >
                ...
                <p className="text-[#FDF8E8]/70 mb-6">
                  Be the first to access the BottleneckBots tutorial when it drops. Plus, get exclusive setup tips and
                ...
                {!submitted ? (
                  ...
                  >
                    <p className="text-[#D4A84B] font-bold text-lg flex items-center justify-center gap-2">
                      ...
                      Success! You'll get the tutorial as soon as it's ready.
                    </p>
                  </motion.div>
                )}
              </motion.div>
          ...
          >
            <p className="text-[#FDF8E8]/60 mb-6">
              Want a custom AI agent built specifically for your business? Let's talk.
            </p>
