...
import { ArrowLeft, BookOpen, Mail, Sparkles } from "lucide-react"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                <span className="block text-[#FDF8E8]">Getting Started</span>
                <motion.span
              ...
              >
                A comprehensive guide to implementing AI in your business workflows. Learn the fundamentals, best
                practices, and proven strategies to transform your operations with artificial intelligence.
              </motion.p>
              ...
              >
                ...
                <p className="text-[#FDF8E8]/70 mb-6">
                  Get notified when this guide launches. Plus, receive exclusive early access to AI automation tips and
                  resources.
                </p>
          ...
          >
            <p className="text-[#FDF8E8]/60 mb-6">
              In the meantime, check out our other resources or book a free consultation to get started with AI today.
            </p>
