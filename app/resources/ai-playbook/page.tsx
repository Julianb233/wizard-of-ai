        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                <FileText className="w-12 h-12 text-[#D4A84B]" />
              </motion.div>
              ...
              >
                <span className="block text-[#FDF8E8]">The AI</span>
                <motion.span
              ...
              >
                Step-by-step strategies for deploying AI solutions that drive real results. This comprehensive playbook
                covers everything from initial assessment to full-scale deployment and optimization.
              </motion.p>
              ...
              >
                ...
                <p className="text-[#FDF8E8]/70 mb-6">
                  Join the waitlist and be among the first to receive the AI Implementation Playbook. Includes exclusive
          ...
          >
            <p className="text-[#FDF8E8]/60 mb-6">
              Ready to start your AI journey now? Book a free consultation to discuss your specific needs.
            </p>
