          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4 pt-6">
              <div className="relative aspect-square rounded-2xl overflow-hidden border-2 border-black/10 hover:scale-105 transition-transform duration-300 cursor-pointer">
                <Image src="/images/bone.png" alt="LN4 Racing merchandise - premium racing apparel" fill className="object-cover" />
              </div>
              <div className="relative aspect-square rounded-2xl overflow-hidden border-2 border-black/10 hover:scale-105 transition-transform duration-300 cursor-pointer">
                <Image src="/images/bone2.png" alt="LN4 Racing merchandise - motorsport collection" fill className="object-cover" />
              </div>
              <div className="relative aspect-square rounded-2xl overflow-hidden border-2 border-black/10 hover:scale-105 transition-transform duration-300 cursor-pointer">
                <Image src="/images/bone3.png" alt="LN4 Racing merchandise - racing accessories" fill className="object-cover" />
              </div>
            </div>
          </div>
