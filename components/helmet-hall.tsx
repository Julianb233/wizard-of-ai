            ...
            >
              <motion.div
                ...
                className="relative aspect-square overflow-hidden rounded-2xl bg-[#0a0a0a] 
                           ...
                           group-hover:border-[#D4A84B] 
                           group-hover:shadow-2xl 
                           group-hover:shadow-[#D4A84B]/20 
              ...
              >
                ...
                <div className="absolute bottom-4 right-4 text-right">
                  ...
                  <p className="text-sm md:text-base font-black text-[#D4A84B] group-hover:scale-110 group-hover:text-white transition-all duration-300 inline-block">
                    {helmet.year}
                  </p>
                </div>
              </motion.div>
